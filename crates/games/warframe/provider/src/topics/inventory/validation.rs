...
use provider_sdk::memory::{Rva, TargetReader};
...
/// Checks family registrations and record layouts.
/// Shared ownership, login, item-type and string-pool layouts are checked by the session.
