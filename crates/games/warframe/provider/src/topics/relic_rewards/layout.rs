...
const OPEN: Rva = Rva::new(0x0065_e370);
const COPY: Rva = Rva::new(0x00e5_9df0);
const STRING_COPY: Rva = Rva::new(0x0133_0fc0);
const SERIALIZER: Rva = Rva::new(0x00e8_3590);
const STORE_ITEM_TYPE: Rva = Rva::new(0x029d_b6f0);
...
pub(crate) fn validate(
    ...
    if read::<15>(reader, OPEN, 0x57)?
        ...
        || read::<7>(reader, OPEN, 0xac)? != [0x48, 0x8d, 0x83, 0xb0, 0x18, 0, 0]
    {
